...
export const translations = {
  it: {
    ...
    cookieBannerDesc: 'Utilizziamo cookie tecnici necessari per il funzionamento del sito. Non utilizziamo cookie di profilazione o tracciamento. Continuando la navigazione accetti l\'uso dei cookie necessari.',
  ...
  en: {
    ...
    cookieBannerDesc: 'We use technical cookies necessary for the website to function. We do not use profiling or tracking cookies. By continuing to browse, you accept the use of necessary cookies.',
  ...
  es: {
    ...
    cookieBannerDesc: 'Utilizamos cookies técnicas necesarias para el funcionamiento del sitio. No utilizamos cookies de perfilado o rastreo.',
  ...
  fr: {
    ...
    cookieBannerDesc: 'Nous utilisons des cookies techniques nécessaires au fonctionnement du site. Nous n\'utilisons pas de cookies de profilage ou de suivi.',
  ...
  de: {
    ...
    cookieBannerDesc: 'Wir verwenden technische Cookies, die für den Betrieb der Website erforderlich sind. Wir verwenden keine Profiling- oder Tracking-Cookies.',
