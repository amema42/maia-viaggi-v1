...
export const translations = {
  it: {
    ...
    // Hero gallery & group trips
    heroClickDiscover: 'clicca per scoprire',
    groupTripsCta: 'Scrivici per date e dettagli',
    groupTripsEyebrow: 'viaggio di gruppo',
    waPrivacyNote: 'I dati selezionati verranno inseriti nel messaggio WhatsApp e gestiti sulla piattaforma WhatsApp/Meta.',
    destWaNote: 'Ti rispondiamo su WhatsApp con proposta e preventivo',
  ...
  en: {
    ...
    heroClickDiscover: 'click to discover',
    groupTripsCta: 'Write us for dates and details',
    groupTripsEyebrow: 'group trip',
    waPrivacyNote: 'Selected data will be included in the WhatsApp message and managed on the WhatsApp/Meta platform.',
    destWaNote: 'We will reply on WhatsApp with a proposal and quote',
  ...
  es: {
    ...
    styleLuxury: 'Lujo',
    styleReligious: 'Religioso',
    heroClickDiscover: 'haz clic para descubrir',
    groupTripsCta: 'Escribenos para fechas y detalles',
    groupTripsEyebrow: 'viaje de grupo',
    waPrivacyNote: 'Los datos seleccionados se incluiran en el mensaje de WhatsApp y se gestionaran en la plataforma WhatsApp/Meta.',
    destWaNote: 'Te respondemos en WhatsApp con propuesta y presupuesto',
  ...
  fr: {
    ...
    heroClickDiscover: 'cliquez pour decouvrir',
    groupTripsCta: 'Ecrivez-nous pour dates et details',
    groupTripsEyebrow: 'voyage de groupe',
    waPrivacyNote: 'Les donnees selectionnees seront incluses dans le message WhatsApp et gerees sur la plateforme WhatsApp/Meta.',
    destWaNote: 'Nous vous repondons sur WhatsApp avec une proposition et un devis',
  ...
  de: {
    ...
    heroClickDiscover: 'klicken zum Entdecken',
    groupTripsCta: 'Schreiben Sie uns fuer Termine und Details',
    groupTripsEyebrow: 'Gruppenreise',
    waPrivacyNote: 'Die ausgewaehlten Daten werden in die WhatsApp-Nachricht eingefuegt und auf der WhatsApp/Meta-Plattform verwaltet.',
    destWaNote: 'Wir antworten Ihnen auf WhatsApp mit Vorschlag und Angebot',
